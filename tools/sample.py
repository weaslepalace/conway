...
have_gimpll = gimp.major_version > 1 or \
...
def python_clothify(timg, tdrawable, bx = 9, by = 9,
    ...
    pdb.plug_in_bump_map(img, tdrawable, bump_layer, azimuthm elevation, depth, 0, 0, 0, 0, TRUE, FALSE, 0)
    
    gimp.delete(img)

register(
    "python_fu_clothify",
    "Make the specified layer look like it is printer on cloth",
    "Make the specified layer look like it is printer on cloth",
    "James Henstridge",
    "James Henstridge",
    "1997-1999"
